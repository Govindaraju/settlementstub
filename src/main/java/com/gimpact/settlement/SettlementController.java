...
import org.gimpact.dto.settlement.SettlementStatus;
...
public class SettlementController {
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "Trade settled successfully", content = @Content(schema = @Schema(implementation = SettlementResponse.class))), @ApiResponse(responseCode = "400", description = "Settlement failed", content = @Content(schema = @Schema(implementation = SettlementResponse.class)))})
    @PostMapping
